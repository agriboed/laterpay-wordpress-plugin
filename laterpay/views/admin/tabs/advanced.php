						...
						<tr>
							<td>
								<label class="lp_toggle__label">
									<input type="checkbox" class="lp_toggle__input" name="debugger_enabled"
										   value="1" 
											<?php
											if ( $_['debugger_enabled'] ) :
	?>
 checked<?php endif; ?>>
						...
						<tr>
							...
							<td>
								<?php
								esc_html_e( 'List of allowed addresses to view debug(Ex.: 127.0.0.1,192.168.1.1)', 'laterpay' );
								?>
							</td>
						</tr>
					</table>
                ...
                the post and replaces the teaser with the full content, if required.', 'laterpay'
					...
					<table class="lp_table--form">
						<tr>
							<td>
								<label class="lp_toggle__label">
									<input type="checkbox" class="lp_toggle__input" name="caching_compatibility"
										   value="1" 
											<?php
											if ( $_['caching_compatibility'] ) :
	?>
 checked<?php endif; ?>>
									<span class="lp_toggle__text" data-on="" data-off=""></span>
									<span class="lp_toggle__handle"></span>
				...
				<fieldset class="lp_fieldset">
					<legend class="lp_legend"><?php esc_html_e( 'LaterPay-enabled Post Types', 'laterpay' ); ?></legend>

					<p class="lp_bold">
						<?php esc_html_e( 'Please choose, which standard and custom post types should be sellable with LaterPay.', 'laterpay' ); ?>
					</p>
...
checked<?php endif; ?>>
				...
				<fieldset class="lp_fieldset">
					<legend class="lp_legend"><?php esc_html_e( 'Offering Time Passes on Free Posts', 'laterpay' ); ?></legend>

					<p class="lp_bold">
						<?php esc_html_e( 'Please choose, if you want to show the time passes widget on free posts, or only on paid posts.', 'laterpay' ); ?>
					</p>
							...
							<td>
								<label class="lp_toggle__label">
									<input type="checkbox" class="lp_toggle__input"
										   ...
										   value="1"
											<?php
											if ( $_['show_time_passes_widget_on_free_posts'] ) :
?>
checked<?php endif; ?>>
									<span class="lp_toggle__text" data-on="" data-off=""></span>
									<span class="lp_toggle__handle"></span>
							...
							<td>
								<?php esc_html_e( 'I want to display the time passes widget on free and paid posts', 'laterpay' ); ?>
							</td>
						</tr>
					</table>
				</fieldset>
				...
				<fieldset class="lp_fieldset">
					<legend class="lp_legend"><?php esc_html_e( 'Require login', 'laterpay' ); ?></legend>

					<p class="lp_bold">
						<?php esc_html_e( 'Please choose if you want to require a login for "Pay Later" purchases.', 'laterpay' ); ?>
					</p>
...
checked<?php endif; ?>>
							...
							<td>
								<?php esc_html_e( 'Require the user to log in to LaterPay before a "Pay Later" purchase.', 'laterpay' ); ?>
							</td>
						</tr>
					</table>
				</fieldset>
				...
				<fieldset class="lp_fieldset">
					<legend class="lp_legend"><?php esc_html_e( 'Gift Codes Limit', 'laterpay' ); ?></legend>

					<p class="lp_bold">
						<?php esc_html_e( 'Specify, how many times a gift code can be redeemed for the associated time pass.', 'laterpay' ); ?>
					</p>
				...
				<fieldset class="lp_fieldset">
					<legend class="lp_legend"><?php esc_html_e( 'Automatically Generated Teaser Content', 'laterpay' ); ?></legend>
                ...
                into the teaser content editor for that post.', 'laterpay'
					...
					<table class="lp_table--form">
						<tr>
							...
							<td>
								<?php esc_html_e( 'Number of words extracted from paid posts as teaser content.', 'laterpay' ); ?>
							</td>
						</tr>
					</table>
				</fieldset>
				...
				<fieldset class="lp_fieldset">
					<legend class="lp_legend"><?php esc_html_e( 'Content Preview under Overlay', 'laterpay' ); ?></legend>
                ...
                These settings do not affect the teaser content in any way.', 'laterpay'
					...
					<table class="lp_table--form">
						<tr>
							...
							<td>
								<?php esc_html_e( 'Percentage of content to be extracted; 20 means "extract 20% of the total number of words of the post".', 'laterpay' ); ?>
							</td>
						...
						<tr>
							...
							<td>
								<?php esc_html_e( 'Applied if number of words as percentage of the total number of words is less than this value.', 'laterpay' ); ?>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<?php esc_html_e( 'Applied if number of words as percentage of the total number of words exceeds this value.', 'laterpay' ); ?>
							</td>
						</tr>
					</table>
				</fieldset>
				...
				<fieldset class="lp_fieldset">
					<legend class="lp_legend"><?php esc_html_e( 'Unlimited Access to Paid Content', 'laterpay' ); ?></legend>
...
checked<?php endif; ?> />
				...
				<fieldset class="lp_fieldset">
					...
					<p class="lp_bold">
						<?php echo wp_kses_post( __( 'Define fallback behavior in case LaterPay API is not responding and option to disallow plugin to contact LaterPay API on homepage', 'laterpay' ) ); ?>
					</p>
	...
	?>
 selected<?php endif; ?>
											value="0"><?php esc_html_e( 'Do nothing', 'laterpay' ); ?></option>
									<option
										<?php
										if ( $_['api_fallback_behavior'] === 1 ) :
	?>
 selected<?php endif; ?>
											value="1"><?php esc_html_e( 'Give full access', 'laterpay' ); ?></option>
									<option
										<?php
										if ( $_['api_fallback_behavior'] === 2 ) :
	?>
 selected<?php endif; ?>
											value="2"><?php esc_html_e( 'Hide premium content', 'laterpay' ); ?></option>
								</select>
							</td>
							<td>

...
<div class="lp_rating-results">
	<div class="lp_rating-results__aggregated-result">
		...
		<?php for ( $i = 1; $i < 6; $i++ ) : ?>
			...
			} elseif ( $i == $laterpay['post_aggregated_rating'] + 0.5 ) {
				// half star
...
">
				...
				<?php endfor; ?>
					...
					<div class="lp_rating__background-bar">
						<div class="lp_rating__bar" style="width:
						<?php
						if ( $laterpay['maximum_number_of_votes'] > 0 ) {
							echo laterpay_sanitize_output( $votes / $laterpay['maximum_number_of_votes'] * 100 ); }
?>
%;">
						</div>
					</div>

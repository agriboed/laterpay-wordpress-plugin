...
<?php
if (true === $laterpay['hide_preview_mode_pane']) {
    echo ' lp_is-hidden';
}
?>
">
    <form id="lp_js_previewModeVisibilityForm" method="post">
        ...
        <input type="hidden" id="lp_js_previewModeVisibilityInput" name="hide_preview_mode_pane"
               value="<?php echo esc_attr($laterpay['hide_preview_mode_pane']); ?>">
        <?php
    ...
    <a href="#" id="lp_js_togglePreviewModeVisibility" class="lp_post-preview-mode__visibility-toggle"
       data-icon="l"></a>
    <h2 class="lp_post-preview-mode__title" data-icon="a"><?php echo esc_html(__('Post Preview Mode',
            'laterpay')); ?></h2>
    <div class="lp_post-preview-mode__plugin-preview-mode">
        <?php echo esc_html(__('Preview post as', 'laterpay')); ?> <strong><?php echo esc_html(__('Admin',
                'laterpay')); ?></strong>
        <div class="lp_toggle">
            <form id="lp_js_previewModeForm" method="post">
                ...
                <label class="lp_toggle__label">
                    <input type="checkbox"
                        ...
                        <?php if (true === $laterpay['preview_post_as_visitor']) : ?>
                            checked
                        <?php endif; ?>>
                    <input type="hidden"
                           name="preview_post"
                           ...
                           value="
							<?php
                           if (true === $laterpay['preview_post_as_visitor']) {
                               echo 1;
                           } else {
                               echo 0;
                           }
...
">
        ...
        <strong><?php echo esc_html(__('Visitor', 'laterpay')); ?></strong>
    </div>
</div>

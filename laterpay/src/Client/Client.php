...
namespace LaterPay\Client;

use LaterPay\Client\Auth\JWT;
use LaterPay\Client\Auth\Signing;
use LaterPay\Client\Http\Transport;
...
class Client
{
    ...
    public function getLoginDialogURL($returnURL, $useJSEvents = false)
    {
        ...
        $url = $this->dialogURL . '/account/dialog/login?next=';
        $url .= rawurlencode($returnURL) . $aux . '&cp=' . $this->merchantID;
    ...
    {
        $aux = $useJSEvents ? '&jsevents=1' : '';
        $url = $this->dialogURL . '/account/dialog/signup?next=';
        $url .= rawurlencode($returnURL) . $aux . '&cp=' . $this->merchantID;
    ...
    {
        $aux = $useJSEvents ? '&jsevents=1' : '';
        $url = $this->dialogURL . '/account/dialog/logout?next=';
        $url .= rawurlencode($returnURL) . $aux . '&cp=' . $this->merchantID;
     ...
     */
    public function signAndEncode(array $params = array(), $url = null)
    {

...
namespace LaterPay\Client\Auth;
...
class Signing
{
     ...
     * @return string
     */
    protected static function createBaseMessage($params, $url, $method = 'POST')
    {
        ...
        $result   = str_replace(
            array('{method}', '{url}', '{params}'),
            array($method, $url, $paramStr),
            $msg
        );
     ...
     * @return string
     */
    protected static function sign($secret = null, array $params = array(), $url = null, $method = 'POST')
    {
     ...
     */
    public static function signAndEncode($secret = null, array $params = array(), $url = null, $method = 'GET')
    {
        if (! isset($params['ts'])) {

...
class Appearance extends TabAbstract
{
            ...
            case 'paid_content_preview':
                ...
                if ($result) {
                    switch (get_option('laterpay_teaser_mode')) {
                        case '1':
                            $message = __(
                                'Visitors will now see the teaser content of paid 
                                posts plus an excerpt of the real content under an overlay.',
                                'laterpay'
                            );
                            break;
                        case '2':
                            $message = __(
                                'Visitors will now see the teaser content of paid posts 
                                plus an excerpt of the real content under an overlay with all purchase options.',
                                'laterpay'
                            );
                            break;
                        default:
    ...
    public function help()
    {
        ...
        $screen->add_help_tab(
            ...
            <ul>
                <li>
                    <strong>Default position</strong> &ndash; The LaterPay purchase button is displayed 
                    at the top on the right below the title.
                </li>
                <li>
                    <strong>Custom position</strong> &ndash; You can position the LaterPay purchase button 
                    yourself by using the stated WordPress action.
                </li>
            </ul>',
                    'laterpay'
                ),
        ...
        $screen->add_help_tab(
            ...
            <ul>
                <li>
                    <strong>Default position</strong> &ndash; Time passes are displayed right below each paid article.
                    <br>
                    If you want to display time passes also for free posts, you can choose \'I 
                    want to display the time passes widget on free and paid posts\' in the plugin\'s 
                    advanced settings (Settings > LaterPay).
                </li>
                <li>
                    <strong>Custom position</strong> &ndash; You can position time passes yourself by using 
                    the stated WordPress action.
                </li>
            </ul>',
                    'laterpay'
                ),

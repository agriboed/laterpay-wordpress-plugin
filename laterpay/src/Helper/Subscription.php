...
class Subscription
{
    ...
    public static function getSubscriptionPurchaseLink($id, $data = null)
    {
        ...
        return Client::getSubscriptionURL($params);
    }
    ...
    public static function getSubscriptionsListByPostID(
        ...
        if (null !== $subscriptionsWithAccess &&
            is_array($subscriptionsWithAccess) && ! empty($subscriptionsWithAccess)) {
            ...
            if ($hasAccess) {
                ...
                if (isset($coveredCategories['excluded'])) {
                    $subscriptions = $subscriptionModel
                        ->getSubscriptionsByCategoryIDs(array($coveredCategories['excluded']));
                } else {
                    $subscriptions = $subscriptionModel
                        ->getSubscriptionsByCategoryIDs(
                            $coveredCategories['included'],
                            true
                        );
                }
            }

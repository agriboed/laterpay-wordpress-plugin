...
class Html extends Normalizer
{
    ...
    public function format(array $record)
    {
        ...
        $output .= '<tr><td class="lp_debugger-content__table-td" colspan="2">';
        $output .= '<table class="lp_debugger-content__table">';
     ...
     * @return string
     */
    private function addHeadRow($message = '', $level = null)
    {
        ...
        $html = '<thead class="lp_js_debuggerContentTableTitle lp_debugger-content__table-title">
            <tr>
                <td class="lp_debugger-content__table-td">
                <span class="lp_debugger__log-level lp_debugger__log-level--' . esc_attr($level) . ' lp_vectorIcon">
                </span>
                ' . esc_html($message) . '</td>

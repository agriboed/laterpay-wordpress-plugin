...
class Hooks
{
    ...
    public function init()
    {
        ...
        foreach (laterpay_get_plugin_config()->get('content.enabled_post_types') as $post_type) {
            ...
            add_action(
                ...
                array( $this, static::$actionPrefix . 'laterpay_post_custom_column_data' ),
                10,
                2
            );
        }
        ...
        add_action(
            ...
            array( $this, static::$actionPrefix . 'laterpay_transition_post_status' ),
            10,
            3
        );
     ...
     * @return void
     */
    public static function registerLaterpayShortcode($eventName)
    {
        if (! in_array($eventName, static::$lpShortcodes, true)) {
            return;
        }

        if (strpos($eventName, 'laterpay_shortcode_') !== false) {
            $name = substr($eventName, 19);

            static::addShortcode($name, $eventName);
            static::$lpShortcodes[] = $eventName;
        }
    }
